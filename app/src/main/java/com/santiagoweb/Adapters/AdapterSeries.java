...
public class AdapterSeries extends RecyclerView.Adapter<AdapterSeries.RecyclerViewHolder> implements  Filterable {


    private ArrayList<seriesResponse.ResultsEntity> dataSet;
    private ArrayList<seriesResponse.ResultsEntity> mFilteredList;
    private Activity activity;

    public AdapterSeries(ArrayList<seriesResponse.ResultsEntity> array, Activity activity) {
        this.dataSet = array;
    ...
    public void onBindViewHolder(@NonNull RecyclerViewHolder holder, int i) {
        seriesResponse.ResultsEntity data = mFilteredList.get(i);
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<seriesResponse.ResultsEntity> filteredList = new ArrayList<>();

                    for (seriesResponse.ResultsEntity row : dataSet) {
...
//                        }
            ...
            protected void publishResults(CharSequence charSequence, FilterResults filterResults) {
                mFilteredList = (ArrayList<seriesResponse.ResultsEntity>) filterResults.values;
